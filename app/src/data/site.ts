...
export const showcases: Showcase[] = [
  ...
  { id: 'cyberpunk-esports', no: '44', title: '電競戰隊 (Cyberpunk Glitch)', clientType: '電競 / 串流', slug: '44-cyberpunk-esports', href: '/showcase/44-cyberpunk-esports/', accent: 'var(--accent-2)' },
  { id: 'organic-skincare', no: '45', title: '植萃保養 (Organic)', clientType: 'Clean Beauty / 美妝', slug: '45-organic-skincare', href: '/showcase/45-organic-skincare/', accent: 'var(--accent)' },
  { id: 'ai-saas-dashboard', no: '46', title: 'AI 數據平台 (Modern SaaS)', clientType: 'AI / SaaS', slug: '46-ai-saas-dashboard', href: '/showcase/46-ai-saas-dashboard/', accent: 'var(--accent-2)' },
  { id: 'architecture-minimal', no: '47', title: '建築室內事務所 (極簡)', clientType: '建築 / 室內設計', slug: '47-architecture-minimal', href: '/showcase/47-architecture-minimal/', accent: 'var(--accent)' },
  { id: 'boutique-hotel', no: '48', title: '精品旅宿 (沉浸視差)', clientType: '旅宿 / 觀光', slug: '48-boutique-hotel', href: '/showcase/48-boutique-hotel/', accent: 'var(--accent-2)' },
  { id: 'law-firm-authority', no: '49', title: '法律顧問事務所 (權威)', clientType: '法律 / 專業服務', slug: '49-law-firm', href: '/showcase/49-law-firm/', accent: 'var(--accent)' },
  { id: 'kids-education', no: '50', title: '親子教育品牌 (Playful)', clientType: '兒童 / 教育', slug: '50-kids-education', href: '/showcase/50-kids-education/', accent: 'var(--accent-2)' },
  { id: 'indie-bookstore', no: '51', title: '獨立書店出版 (文學復古)', clientType: '出版 / 書店', slug: '51-indie-bookstore', href: '/showcase/51-indie-bookstore/', accent: 'var(--accent)' },
  { id: 'tech-hardware', no: '52', title: '科技硬體產品 (3C)', clientType: '消費電子 / 硬體', slug: '52-tech-hardware', href: '/showcase/52-tech-hardware/', accent: 'var(--accent-2)' },
  { id: 'bubble-tea', no: '53', title: '手搖飲連鎖 (台味活潑)', clientType: '餐飲 / 連鎖', slug: '53-bubble-tea', href: '/showcase/53-bubble-tea/', accent: 'var(--accent)' },
  { id: 'wedding-invite', no: '54', title: '婚禮邀請 (優雅互動)', clientType: '婚禮 / 活動', slug: '54-wedding-invite', href: '/showcase/54-wedding-invite/', accent: 'var(--accent-2)' },
  { id: 'photographer-portfolio', no: '55', title: '攝影師作品集 (全幅留白)', clientType: '攝影 / 創意', slug: '55-photographer-portfolio', href: '/showcase/55-photographer-portfolio/', accent: 'var(--accent)' },
  { id: 'luxury-realestate', no: '56', title: '豪宅地產 (奢華大圖)', clientType: '房地產 / 豪宅', slug: '56-luxury-realestate', href: '/showcase/56-luxury-realestate/', accent: 'var(--accent-2)' },
  { id: 'clean-energy', no: '57', title: '永續能源科技 (信任)', clientType: '綠能 / B2B', slug: '57-clean-energy', href: '/showcase/57-clean-energy/', accent: 'var(--accent)' },
  { id: 'podcast-show', no: '58', title: 'Podcast 節目 (聲音品牌)', clientType: '內容 / 音訊', slug: '58-podcast-show', href: '/showcase/58-podcast-show/', accent: 'var(--accent-2)' },
  { id: 'pet-store', no: '59', title: '寵物用品電商 (溫暖)', clientType: '寵物 / 電商', slug: '59-pet-store', href: '/showcase/59-pet-store/', accent: 'var(--accent)' },
  { id: 'art-exhibition', no: '60', title: '美術館展覽 (策展編輯)', clientType: '藝文 / 展覽', slug: '60-art-exhibition', href: '/showcase/60-art-exhibition/', accent: 'var(--accent-2)' },
